...
Version  : 0.97.1
Release  : 2
URL      : http://ftp.acc.umu.se/pub/gnome/sources/dia/0.97/dia-0.97.1.tar.gz
Source0  : http://ftp.acc.umu.se/pub/gnome/sources/dia/0.97/dia-0.97.1.tar.gz
...
%package bin
Summary: bin components for the dia package.
Group: Binaries
Requires: dia-data

%description bin
bin components for the dia package.


%package data
Summary: data components for the dia package.
Group: Data

%description data
data components for the dia package.


%package doc
Summary: doc components for the dia package.
Group: Documentation

%description doc
doc components for the dia package.


%package lib
Summary: lib components for the dia package.
Group: Libraries
Requires: dia-data

%description lib
lib components for the dia package.


%package locales
Summary: locales components for the dia package.
Group: Default

%description locales
locales components for the dia package.


%prep
%setup -q -n dia-0.97.1
